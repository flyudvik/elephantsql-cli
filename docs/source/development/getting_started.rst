...
The source code for the `elephantsql_cli` project lives at
`github <https://github.com/flyudvik/elephantsql_cli>`_.  You can use `git clone` to get it.

.. code-block:: bash

   git clone https://github.com/flyudvik/elephantsql_cli
